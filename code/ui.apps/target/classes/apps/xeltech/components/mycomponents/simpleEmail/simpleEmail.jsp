...
<button id="submitbutton" type="button"  onclick="alert('You pressed the button!')">SendEmail</button> 
...
<%!
    ...
    public void sendEmail ()
    {
        ...
        emailParams.put("senderEmailAddress","yash.xelium@gmail.com");
        emailParams.put("senderName","David Smith");
        emailParams.put("recipientName","John Doe");
        
        // Array of email recipients
        String[] recipients = { "yashduggal5@gmail.com" };
